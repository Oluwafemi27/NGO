...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Veronika Bakoz Charity Foundation" },
      {
        name: "description",
        content:
          "Empowering widows and less-privileged women and children in Lokoja, Kogi State through skills, capital and community.",
      },
      { property: "og:site_name", content: "Veronika Bakoz Charity Foundation" },
    ...
    links: [
      ...
      // No favicon shipped yet — add public/favicon.ico (or an <link rel="icon">
      // pointing at your own asset) and reinstate a link here when you have one.
    ],
    scripts: [
      {
